...
```{r load_covar}
cfg = read_configuration(scientificname = "Squalus acanthias",
                         version = "v1", 
...
```{r load_workflow}
model_fits = read_model_fit(filename = "Squalus_acanthias-v1-model_fits")
model_fits
```
...
plot_prediction(forecast_2075['default_maxent'])
```
