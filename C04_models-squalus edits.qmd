...
```{r load_data}
cfg = read_configuration(scientificname = "Squalus acanthias", version = "v1")
model_input = read_model_input(scientificname = "Squalus acanthias", 
                               version = "v1",
                               log_me = c("depth", "Xbtm")) |>
...
model_fits = workflowset_selectomatic(wflow, model_input_split,
                                  filename = "Squalus_acanthias-v1-model_fits",
...
```{r pd_plot}
model_fit_pdp(model_fits, wid = "default_maxent", title = "Maxium Entropy")
```
